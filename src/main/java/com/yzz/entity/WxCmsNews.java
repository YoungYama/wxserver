...
/** 
* 
* @description: wx_cms_news表的实体类WxCmsNews 
* 
* @author 杨志钊 
* @date 2017-04-17 18:20:30 
*/ 

public class WxCmsNews {

	private String wxCmsNewsId;//图文ID
	...
	public String getWxCmsNewsId() { 
		return wxCmsNewsId; 
	} 

	public void setWxCmsNewsId(String wxCmsNewsId) { 
 		this.wxCmsNewsId = wxCmsNewsId == null ? null : wxCmsNewsId.trim(); 
	} 
